        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {categories.map((category, index) => {
              ...
              return (
                <Card key={category.title} className="card-warm fade-in group cursor-pointer">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-semibold text-foreground mb-2 rtl">
                      {category.title}
                    </h3>
                    <p className="text-sm text-muted-foreground rtl leading-relaxed">
          ...
          <Button 
            ...
            size="lg"
            className="btn-cta text-lg px-8 py-4 rtl fade-in-delayed"
          >
            مشاهده منوی کامل
          </Button>
        </div>
