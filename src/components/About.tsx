          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="rtl order-2 lg:order-1">
              ...
              <div className="space-y-6 text-lg leading-relaxed text-muted-foreground fade-in-delayed">
                <p className="text-neutral-700">در دل طبیعت بکر ده بالا، جایی میان آرامش کوه و هوای دلنشین با فضایی گرم و صمیمی میزبان لحظه‌های خوش شماست. ما ترکیبی از طعم‌های اصیل، دکور دل‌نشین  را گرد هم آورده‌ایم تا هر حضور شما، تجربه‌ای خوش و ماندگار باشد.</p>
                <p className="text-neutral-700">اینجا فقط یه کافه رستوران نیست، یه پاتوق صمیمیه برای دورهمی‌های دوستانه و صمیمی، یا حتی یه عصر خلوت با یه فنجون قهوه‌ی خوش‌عطر.
